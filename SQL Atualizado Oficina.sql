...
INSERT INTO `conserto` (`idConserto`, `precoConserto`, `descricaoDefeito`, `consertoRealizado`, `dataConserto`, `Tecnico_idTecnico`, `Aparelho_idAparelho`) VALUES
	(1, 22.00, 'Cabo partido', 'Troca de chapa', '2019-11-21', 2, 2),
	(2, 12.00, 'Cabo partido', 'Troca de chapa', '2019-11-21', 2, 2),
	(3, 20.00, 'Resistencia queimada', 'Troca de cabo', '2019-01-12', 2, 1);
...
-- Copiando dados para a tabela oficinaeletro.tecnico: ~0 rows (aproximadamente)
